...
export default function ControlPage() {
  ...
  return (
    <div>
      <h1 className="font-bold text-3xl text-emerald-800">Incubator Control</h1>

      <div className="grid grid-cols-2 mt-12 w-1/2 gap-4">
        {/* control inkubasi */}
        ...
        <div className="relative border-2 border-green-400 p-5 pt-8 text-center font-mono w-full col-span-2 mt-5">
